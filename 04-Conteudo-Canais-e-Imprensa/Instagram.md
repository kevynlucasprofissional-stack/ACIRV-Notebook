...
Distribuir conteúdo dos cinco pilares e conduzir o público a inscrição, site, WhatsApp ou contato quando houver objetivo de conversão.

## Mix

Carrossel para explicação e salvamento; Reels para alcance e demonstração; Feed estático para serviço/registro; Stories para frequência, bastidor, lembrete e interação.

## Governança

Cada publicação precisa de pilar, público, objetivo, CTA, fonte, responsável, aprovação e métrica.
...
Planejar por capacidade e eventos, não por meta abstrata de volume.
